...
<body id="home" class="homepage">
    ...
    <header id="header">
      ...
      <!--/#login-->
    <section id="login">
    <form:form method = "POST" action = "/productiveWaitWeb/login" modelAttribute="user">
                        ...
                        <div class="contact-form">
                            ...
                            <form id="main-contact-form" name="contact-form" method="post" action="#">
                                ...
                                <div class="form-group">
                                     <input type="text" name="username" class="form-control" placeholder="Username" value="khurana26" required>
<%--                                          <form:input path="userName"/> --%>
                                </div>
                                <div class="form-group">
                                    <input type="password" name="password" class="form-control" placeholder="Password" value="test123" required>
                                </div>
